...
namespace Gaea.Utils
{
    ...
    public static class NodeUtils
    {
        ...
        public static Node GetSingleton(this Godot.SceneTree tree, string name)
        {
        ...
        public static void AddSingleton<T>(this Godot.SceneTree tree, T singleton) where T : Node
        {
        ...
        /// <param name="singleton">Singleton being added</param>
        /// <param name="name">Name of the singleton</param>
        public static void AddSingleton(this Godot.SceneTree tree, Node singleton, string name)
        {
            singleton.Name = name;
        ...
        /// <param name="name">Name of the singleton</param>
        public static void RemoveSingleton(this Godot.SceneTree tree, string name)
        {
            if (tree.Root.HasNode(name))
