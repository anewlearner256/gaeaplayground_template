...
uniform float luma_coef :hint_range(0,1) = 0.1;
uniform float color_coef :hint_range(0,1) = 0.1;
uniform float depth_coef :hint_range(0,1) = 0.8;
uniform float cutoff :hint_range(0,1) = 0.2;
