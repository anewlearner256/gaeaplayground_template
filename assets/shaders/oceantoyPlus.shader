...
uniform float fresnelF = 0.022;
uniform int NUM_STEPS = 2;
uniform float uvF = 0.964;
...
//    fresnel = pow(fresnel,3.0) * fresnelF;
//
...
//    vec3 refracted = SEA_BASE.xyz + diffuse(n,l,diffuseF) * SEA_WATER_COLOR.xyz * reflectF; 
//
...
//    color += vec3(specular(n,l,eye,90))*distFactor;
//    return color;
    ...
    color += vec3(specular(n,l,eye,60.0)) * distFactor;
